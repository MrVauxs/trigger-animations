...
class CanvasPanFlowNode extends CanvasPanModifierNode<TInputs> {
	...
	static override get defineInputs(): T.InputEntrySchemaSource[] | null {
		return [
			...
			{ key: "waitDelayMin", type: "number", ...this.io("waitDelayMin"), group: "wait", field: { default: 0 } },
			{ key: "waitDelayMax", type: "number", ...this.io("waitDelayMax"), group: "wait", field: { default: 0 } },
			{ key: "delayMin", type: "number", ...this.io("delayMin"), group: "delay", field: { default: 0, min: 0 } },
			{ key: "delayMax", type: "number", ...this.io("delayMax"), group: "delay", field: { default: 0, min: 0 } },
